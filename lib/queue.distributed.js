...
/**
 * A `DistributedQueue` is a write-only queue that forwards
...
var DistributedQueue = exports.DistributedQueue = function DistributedQueue(strategy) {
